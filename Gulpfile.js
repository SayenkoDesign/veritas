...
// Settings
//const proxy_url = 'veritas.dev'; // using SSL? Don't forget to set the Watch https keys
const proxy_url = 'https://veritas.vanwp.ca';
//const proxy_url = 'http://localhost:8888/veritas';
